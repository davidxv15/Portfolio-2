    ...
    <section className="section flex flex-col items-center justify-evenly h-screen w-screen bg-gradient-to-t from-sky-600 via-blue-100 to-blue-100 text-center md:mt-5 lg:mt-4 md:-translate-y-5">
      ...
      <div className="mb-8 md:mb-16 md:w-2/3">
        <img
          ...
          alt="My Portrait"
          className="rounded-full w-72 h-72 lg:w-96 lg:h-96 object-cover object-[80%_6%] shadow-lg shadow-gray-600 md:absolute md:top-48 md:left-24 lg:left-36 lg:top-56 lg:-translate-y-24 transition-all duration-900 ease-in-out animate-fade"
        />
      </div>
