  ...
  return (
    <section className="section flex flex-col items-center justify-evenly h-screen w-screen bg-gradient-to-t from-sky-600 via-blue-100 to-blue-100 text-center md:mt-5 lg:mt-4 md:-translate-y-5">
      ...
      <div className="mt-4 md:ml-96 md:mb-20 lg:space-x-12">
        ...
        <button className="bg-slate-100 text-blue-700 hover:text-slate-100 px-6 py-2 rounded-full shadow hover:bg-blue-400 hover:border-slate-300 ml-4 shadow-md shadow-gray-600 md:-translate-y-20 lg:-translate-y-32 hover:scale-125 transform transition duration-400">
          Contact Me
        </button>
      </div>
