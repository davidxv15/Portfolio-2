    ...
    <section className="section flex flex-col items-center justify-evenly h-screen w-screen bg-gradient-to-t from-sky-600 via-blue-100 to-blue-100 text-center md:mt-5 lg:mt-4 md:-translate-y-5">
      ...
      <div className="mb-8 md:mb-16 md:w-2/3">
        <img
          ...
          alt="My Portrait"
          className="rounded-full w-72 h-72 lg:w-96 lg:h-96 object-cover object-[80%_6%] shadow-lg shadow-gray-600 md:absolute md:top-48 md:left-24 lg:left-28 xl:left-56 lg:top-48 lg:-translate-y-24 xl:top-60 transition-all duration-900 ease-in-out animate-fade"
        />
      </div>
      <div className="mt-4 md:ml-96 md:mb-20 lg:space-x-12">
        <button className="bg-blue-900 text-white px-6 py-2 rounded-full hover:bg-blue-600 transition font-outfit shadow shadow-md shadow-gray-600 md:-translate-y-20 lg:-translate-y-32 hover:scale-125 transform transition duration-300">
          View My Work
        </button>
        <button className="bg-slate-100 text-blue-700 hover:text-slate-100 px-6 py-2 rounded-full hover:bg-blue-400 hover:border-slate-300 ml-4 shadow shadow-md shadow-gray-600 md:-translate-y-20 lg:-translate-y-32 hover:scale-125 transform transition duration-300">
          Contact Me
        </button>
      </div>
