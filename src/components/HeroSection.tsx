...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="pt-20 section flex flex-col items-center justify-evenly h-screen w-screen bg-gradient-to-t from-sky-600 via-blue-100 to-blue-100 text-center ">
