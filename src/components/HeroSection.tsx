...
const HeroSection: React.FC = () => {
   return (
    <section className="flex flex-col items-center justify-evenly h-screen w-screen bg-gradient-to-t from-blue-200 via-blue-200 to-blue-200 text-center">
      <div className="mb-2">
        <h1 className="text-4.5xl font-league font-bold text-black mt-4"><span className="text-5xl">D</span>AVID <span className="text-5xl">V</span>ELASQUEZ</h1>
      ...
      <div className="flex space-x-4 mt-6">
        ...
        <a href="https://www.linkedin.com/in/david-velasquez-az/" target="_blank" rel="noopener noreferrer">
          <img src="inLinked.png" alt="LinkedIn logo" className="w-14 h-14 rounded-full object-cover shadow-md shadow-gray-600 object-[30%_5%]" />
        </a>
      </div>
    </section>
  );
