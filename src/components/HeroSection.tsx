    ...
    <section className="section flex flex-col items-center justify-evenly h-screen w-screen bg-gradient-to-t from-sky-600 via-blue-100 to-blue-100 text-center">
      ...
      <div className="mb-8 md:mb-16 md:w-2/3">
        <img
          ...
          alt="My Portrait"
          className="rounded-full w-72 h-72 lg:w-96 lg:h-96 xl:w-106 xl:h-120 object-cover object-[80%_6%] shadow-lg shadow-gray-600 -translate-x-14 -translate-y-8 md:top-40 md:left-20 lg:top-10 lg:left-16 xl:left-60 xl:top-60 transition-all duration-200 ease-in-out animate-fade z-30 no-invert"
        />
      </div>
