    ...
    <section className="section flex flex-col items-center justify-evenly h-screen w-screen bg-gradient-to-t from-sky-600 via-blue-100 to-blue-100 text-center">
      <div className="mb-2 bg-gradient-to-b from-blue-100 via-blue-100 to-blue-100">
        <h1
         ...
         w-3/4 mx-auto outline-none sm:-translate-y-12 md:-translate-y-4 lg:translate-y-20"
        >
        ...
        <br />
        <h2 className="text-5xl font-poppins text-slate-900 mt-1 md:text-left lg:text-center md:mr-32 md:ml-[50%] text-center lg:mr-16 lg:translate-y-20 lg:w-90 md:whitespace-nowrap md:text-4xl lg:whitespace-nowrap">
          Software Developer
        </h2>
      ...
      <div className="mb-8 md:mb-16 md:w-2/3">
        <img
          ...
          alt="My Portrait"
          className="rounded-full w-72 h-72 lg:w-96 lg:h-96 xl:w-106 xl:h-120 object-cover object-[80%_6%] shadow-lg shadow-gray-600 md:top-40 md:left-24 lg:top-10 lg:left-20 xl:left-60 xl:top-60 transition-all duration-900 ease-in-out animate-fade z-30 no-invert"
        />
      </div>
