...
const Projects: React.FC = () => {
  ...
  return (
    <section
      ...
      id="projects"
    >
      <h2 className="text-5xl font-league text-slate-900 text-center mb-8">
        Projects
      </h2>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {projectData.map((project, index) => (
          <div
            key={index}
            className="bg-blue-300 shadow-md rounded-3xl overflow-hidden transform transition duration-500 hover:scale-125 hover:justify-items-center hover:z-50 hover:place-content-center"
          >
            <img
              src={project.image}
              alt={project.title}
