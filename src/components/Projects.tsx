    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-6xl mx-auto">
        {projectData.map((project, index) => (
          <div
            key={index}
            className="bg-emerald-400 shadow-md rounded-xl overflow-hidden transform transition duration-500 hover:scale-105 hover:justify-items-center hover:z-50 hover:place-content-center"
          >
            <img
              src={project.image}
              alt={project.title}
