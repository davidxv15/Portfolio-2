    ...
    >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 max-w-fit mx-auto">
        {projectData.map((project, index) => (
          <div
            key={index}
            className="bg-slate-500 shadow-lg shadow-gray-600 rounded-xl border border-black overflow-hidden transform transition duration-500 hover:justify-items-center hover:z-50 hover:place-content-center"
          >
            <img
              src={project.image}
              alt={project.title}
