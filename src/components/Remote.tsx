...
const FRICTION = 0.03; // Gradual slow-down
const TURN_SPEED = 8; // How fast the car turns
const MAX_SPEED = 7; // Maximum forward speed
const REVERSE_SPEED = -1; // Maximum reverse speed
  ...
  return (
    <div className="relative w-full h-[50vh] flex flex-col items-center justify-center bg-gray-900 text-slate-100">
      ...
      <motion.div
        ...
        className="absolute w-24 h-16 bg-red-600 rounded-lg flex items-center justify-center"
      >
        {/*  Wheels */}
        <div className="w-6 h-6 bg-black rounded-full absolute -left-3 top-2"></div>
        <div className="w-6 h-6 bg-black rounded-full absolute -left-3 bottom-2"></div>
