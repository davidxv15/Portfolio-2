  ...
  return (
    <div className="flex justify-end items-center bg-transparent mb-1">
      ...
      <button
        ...
        className="relative w-18 h-6 bg-gray-900 mr-4 rounded-full shadow-inner focus:outline-none hover:border-gray-300 shadow shadow-gray-400"
      ...
      >
        ...
        top: '.05rem',
          ...
          className="toggle-dot absolute left-0 top-0 h-5 w-5 bg-blue-700 shadow-inner rounded-full shadow shadow-gray-300 transform transition-transform duration-900 ease-in-out"
        ></div>
      </button>
    </div>
  );
