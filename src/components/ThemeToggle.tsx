  ...
  return (
    <div className="flex justify-end items-center bg-transparent mb-1">
      ...
      <button
        ...
        className="relative w-18 h-6 bg-gray-200 mr-4 rounded-full shadow-inner mt-1 focus:outline-none border-blue-600 hover:border-white shadow shadow-gray-700"
