  ...
  return (
    <div className="flex justify-end items-center bg-transparent mb-1">
      ...
      <button
        ...
        className="relative w-18 h-6 bg-gray-100 mr-4 rounded-full shadow-inner focus:outline-none hover:border-blue-600 shadow shadow-gray-500"
      ...
      >
        ...
        top: '.05rem',
          ...
          className="toggle-dot absolute left-0 top-0 h-5 w-5 bg-black shadow-inner rounded-full shadow shadow-gray-300 transform transition-transform duration-900 ease-in-out"
        ></div>
      </button>
    </div>
  );
