...
const ThemeToggle: React.FC<ThemeToggleProps> = ({
  ...
  return (
    <div className="flex justify-end items-center bg-transparent mb-0">
      <span className="ml-4 mr-1 font-medium text-slate-200 p-4">
        {themes[currentThemeIndex]}
      </span>
      <div className="relative flex items-center justify-center p-2 rounded-full hover:bg-gray-300/10 transition duration-200 p-8 cursor-pointer">

      <button
        onClick={handleToggle}
        className="relative w-18 h-6 bg-gray-200 mr-4 rounded-full shadow-inner mt-1 border-blue-100 hover:border-white shadow shadow-gray-700 -translate-y-4"
        ...
        <div
          ...
          className="toggle-dot absolute left-0 top-0 h-5 w-5 bg-blue-950 shadow-inner rounded-full shadow shadow-gray-300 transform transition-transform duration-900 ease-in-out">
        </div>
       </button>
      </div>
    </div>
