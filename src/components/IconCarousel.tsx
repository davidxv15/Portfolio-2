...
const IconCarousel: React.FC<IconCarouselProps> = ({ reverse = false }) => {
  ...
  return (
    <div className="relative group w-screen">
      <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 translate-y-2 bg-slate-800 text-gray-300 text-lg px-4 py-1 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50">
