    ...
    <div className="rounded-3xl shadow-none w-screen z-10">
      <Slider {...settings}>
        {logos.map((logo, index) => (
          ...
          >
            <div
              className="imgAndH3 smallCard bg-gradient-to-b from-slate-400 via-slate-300 to-slate-600 shadow-md shadow-gray-700 m-1 h-56 sm:w-24 sm:h-44 md:h-44 md:w-40 lg:w-48 lg:h-44"
              style={{
