...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-gradient-to-b from-slate-700 via-slate-800 to-slate-900 text-white z-50 h-16">
      ...
      {isOpen && (
        <div className="sticky md:hidden px-2 pt-2 pb-3 space-y-1 sm:px-3 bg-gradient-to-t from-slate-700 via-slate-800 to-slate-800 font-poppins">
          <a
            href="#"
            className="text-gray-200 block px-3 py-2 rounded-md text-xl hover:bg-gray-100 hover:text-gray-900"
          >
            Home
          </a>
          <a
            href="#projects"
            className="text-gray-200 block px-3 py-2 rounded-md text-xl hover:bg-gray-400 hover:text-gray-900"
          >
            Skills
          </a>
          <a
