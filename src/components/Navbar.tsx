      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-gray-100 text-xl font-outfit flex items-center justify-between h-14">
          ...
          <div className="hidden md:flex space-x-5 tracking-tight text-2xl">
            ...
            <a href="#skills" className="text-gray-100 hover:text-gray-400 no-select">
              Skills
            </a>
            <a href="#projects" className="text-gray-100 hover:text-gray-400 no-select">
              Projects
            </a>
            <a href="#about" className="text-gray-100 hover:text-gray-400 no-select">
              About
            </a>
            <a href="#contact" className="text-gray-100 hover:text-gray-400 no-select">
              Contact
            </a>
          </div>
          {/* Mobile Menu Button */}
