  ...
  return (
    <section className="relative w-auto h-screen mx-auto py-4 h-screen bg-gradient-to-b from-sky-600 to-sky-600 z-0">
      ...
      <div className="relative group w-screen">
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 -translate-y-10 bg-gray-800 text-white text-lg px-4 py-2 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50">
