  ...
  return (
    <section className="relative w-auto h-screen mx-auto py-4 h-screen bg-gradient-to-b from-sky-600 via-sky-300 to-sky-600 z-0">
      ...
      <div className="relative group w-screen">
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 -translate-y-28 bg-slate-800 text-gray-300 text-lg px-4 py-2 rounded-md shadow-lg opacity-0 group-hover:opacity-95 transition-opacity duration-300 z-50">
