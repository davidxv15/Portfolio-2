...
const SkillsCarousel: React.FC<{ tooltipText: string; reverse?: boolean }> = ({
  ...
  return (
    <section className="relative w-auto h-screen mx-auto py-4 h-screen bg-gradient-to-b from-sky-600 via-sky-300 to-sky-600 z-0">
      <h1
        className="scroll-mt-24 text-center text-5xl w-screen md:p-1 md:pb-1 font-poppins z-0 mt-24 mb-10 tracking-wider translate-y-3 text-shadow-subtle text-slate-100"
        id="skills"
      >
        SKILLS
      </h1>
      ...
      <div className="relative group w-screen">
        <div className="absolute top-4 left-1/2 transform -translate-x-1/2 -translate-y-28 bg-slate-800 text-white text-lg px-4 py-2 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-50">
