...
const SkillsCarousel: React.FC<{ tooltipText: string; reverse?: boolean }> = ({
  ...
  return (
    <section className="relative w-auto h-screen mx-auto py-4 h-screen bg-sky-600 z-0 pt-22">
      ...
      {/* tooltip */}
      <div className="relative group w-screen"><div className="absolute top-4 left-1/2 transform -translate-x-1/2 -translate-y-10 bg-gray-700 text-white text-lg px-4 py-2 rounded-md shadow-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10">
