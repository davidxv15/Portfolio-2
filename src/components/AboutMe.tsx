...
{/* Driven by the belief that bold ideas deserve decisive action, I thrive on creating impactful solutions that inspire our future. */}
        ...
        Outside of coding, I enjoy making music, model building, and discovering new ideas that challenge my perspectives and fuel my curiosity.
        </p>
      </div>
    </section>
  );
