  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <span className="font-bold">Software Developer</span> with hands-on problem-solving, creativity, and collaboration experience across diverse technical teams. I bring a strong sense of initiative, consistently transforming vision into action to deliver innovative solutions to complex challenges. My experience includes building responsive web applications with <span>React</span> and <span>TypeScript</span>, where I excel at delivering high-quality results under tight deadlines. With a laser-sharp eye for clean, maintainable code, I enjoy driving projects from conception to deployment, ensuring every detail aligns with the larger picture.

Beyond technical expertise, I excel at building personal connections and fostering professional relationships, creating an environment where collaboration and shared success thrive. Currently, I am charting a path into <span>AI development</span>, integrating machine learning models and exploring the fusion of AI and software engineering to build transformative, intelligent systems.
