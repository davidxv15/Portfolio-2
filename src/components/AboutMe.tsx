  ...
  return (
    ...
    >
      <div className="max-w-4xl mx-auto text-center">
        ...
        <p className="text-xl leading-relaxed mb-8 tracking-wid indent-4 text-justify font-poppins text-slate-400">
...
{/* Driven by the belief that bold ideas deserve decisive action, I thrive on creating impactful solutions that inspire our future. */}
        ...
        <p className="text-lg sm:text-lg leading-relaxed tracking-wide font-light font-poppins text-slate-400">
