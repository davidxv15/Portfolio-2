...
const ZBlaster: React.FC = () => {
  ...
  const handleShoot = () => {
    const bulletX = player.x + PLAYER_SIZE / 2 - 6; // Adjust this for left/right positioning
    const bulletY = player.y - PLAYER_SIZE / 2 - 10; // Adjust this for up/down positioning
